    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('ນະໂຍບາຍຄວາມເປັນສ່ວນຕົວ AutoPass', style: AppTextStyles.h3),
            const SizedBox(height: 16),
            _section('1. ຂໍ້ມູນທີ່ພວກເຮົາເກັບກຳ',
                'ເມື່ອທ່ານໃຊ້ AutoPass ພວກເຮົາເກັບກຳ: ເບີໂທລະສັບ ແລະ ຊື່-ນາມສະກຸນ (ສຳລັບເຂົ້າສູ່ລະບົບ), '
            ...
            _section('4. ການເກັບຮັກສາ ແລະ ຄວາມປອດໄພ',
                'ຂໍ້ມູນຂອງທ່ານຖືກເກັບຮັກສາໄວ້ໃນລະບົບຂອງ AutoPass ຢ່າງປອດໄພ ແລະ ຈະບໍ່ຖືກຂາຍ ຫຼື ແບ່ງປັນໃຫ້ '
            ...
            _section('6. ການປ່ຽນແປງນະໂຍບາຍ',
                'AutoPass ອາດປັບປຸງນະໂຍບາຍນີ້ເປັນບາງຄັ້ງຄາວ ການໃຊ້ງານແອັບຯ ຕໍ່ໄປຫຼັງການປ່ຽນແປງ ຖືວ່າທ່ານ '
