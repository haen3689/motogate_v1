...
/// ຂັ້ນຕອນປະກັນໄພ: 0=ເລືອກລົດ, 1=ເລືອກແພັກເກັດ, 2=ຊຳລະເງິນ
class InsuranceStepIndicator extends StatelessWidget {
  final int currentStep;
  const InsuranceStepIndicator({super.key, required this.currentStep});

  static const _labels = ['ເລືອກລົດ', 'ເລືອກແພັກເກັດ', 'ຊຳລະເງິນ'];
