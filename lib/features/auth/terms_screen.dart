          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  const Text('ຂໍ້ຕົກລົງການໃຊ້ງານ AutoPass', style: AppTextStyles.h3),
                  const SizedBox(height: 16),
                  _section('1. ການຍອມຮັບເງື່ອນໄຂ',
                      'ການໃຊ້ແອັບພລິເຄຊັນ AutoPass ຖືວ່າທ່ານໄດ້ຍອມຮັບເງື່ອນໄຂ ແລະ ຂໍ້ກຳນົດທັງໝົດທີ່ລະບຸໄວ້ໃນເອກະສານນີ້.'),
                  ...
                  _section('4. ຄວາມເປັນສ່ວນຕົວ',
                      'ຂໍ້ມູນສ່ວນຕົວຂອງທ່ານຈະຖືກເກັບຮັກສາໄວ້ຢ່າງລັບ ແລະ ປອດໄພ ຕາມນະໂຍບາຍຄວາມເປັນສ່ວນຕົວຂອງ AutoPass.'),
                  _section('5. ການປ່ຽນແປງ',
                      'AutoPass ສະຫງວນສິດໃນການປ່ຽນແປງເງື່ອນໄຂເຫຼົ່ານີ້ໄດ້ທຸກເວລາ. ການໃຊ້ງານຕໍ່ໄປຖືວ່າທ່ານຍອມຮັບການປ່ຽນແປງດັ່ງກ່າວ.'),
