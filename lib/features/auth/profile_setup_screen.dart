          ...
          children: [
            ...
            _sectionCard(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    _tab('ບັດປະຈຳຕົວ', _isNationalId,
                        () => setState(() => _isNationalId = true)),
                    _tab('Passport', !_isNationalId,
                ...
                _row2(
                  _field('ຊື່ແທ້',
                      req: true, child: _input(_firstNameCtrl, 'ປ້ອນຊື່ແທ້')),
                  _field('ນາມສະກຸນ',
                      req: true, child: _input(_lastNameCtrl, 'ປ້ອນນາມສະກຸນ')),
                ),
                ...
                // ເລກບັດ | ວັນໝົດອາຍຸ
                _row2(
                  _field(_isNationalId ? 'ເລກບັດປະຈຳຕົວ' : 'ເລກ Passport',
                      req: true, child: _input(_idNumberCtrl, '1234567890123')),
                  _field('ວັນໝົດອາຍຸ',
                      req: false,
                      child: _dateTile(
                        value:
                            _idExpiry != null ? _displayDate(_idExpiry!) : null,
                        hint: '31/12/2028',
            ...
            _sectionCard(
              ...
              children: [
                ...
                _row2(
                  ...
                  _field('ເບີໂທ',
                      req: false, child: _readonlyField(_phone ?? '')),
                ),
                const SizedBox(height: 12),
                ...
                _row2(
                  ...
                  _field('ບ້ານ',
                      req: true, child: _input(_villageCtrl, 'ປ້ອນຊື່ບ້ານ')),
                ),
              ],
            ),
            const SizedBox(height: 12),
            ...
            _sectionCard(
              ...
              children: [
                ...
                Row(children: [
                  Expanded(
                      child: _uploadBtn(Icons.photo_library_outlined, 'Gallery',
                          () => _pickImage(ImageSource.gallery))),
                  const SizedBox(width: 10),
                  Expanded(
                      child: _uploadBtn(Icons.camera_alt_outlined, 'ຖ່າຍຮູບ',
  ...
  Widget _sectionCard(
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 14),
          Divider(
              color: AppColors.primaryLight.withValues(alpha: 0.6), height: 1),
          const SizedBox(height: 14),
          ...children,
        ]),
      );
    ...
    required void Function(String?)? onChanged,
      ...
      SizedBox(
        ...
        child: DropdownButtonFormField<String>(
          ...
          isExpanded: true,
          hint: Text(hint,
              style: const TextStyle(fontSize: 14, color: AppColors.grey350)),
